...
data$feature1[data$feature1<lower_bound]<-lower_bound
data$feature1[data$feature1>upper_bound]<-upper_bound
boxplot(data$feature1)
# 2.2 
lower_bound<-quantile(data$feature2, 0.025)
upper_bound<-quantile(data$feature2, 0.975)
data$feature2[data$feature2<lower_bound]<-lower_bound
data$feature2[data$feature2>upper_bound]<-upper_bound
boxplot(data$feature2)
# 2.3
lower_bound<-quantile(data$feature3, 0.025)
upper_bound<-quantile(data$feature3, 0.975)
data$feature3[data$feature3<lower_bound]<-lower_bound
data$feature3[data$feature3>upper_bound]<-upper_bound
boxplot(data$feature3)
# 2.4
lower_bound<-quantile(data$feature4, 0.025)
upper_bound<-quantile(data$feature4, 0.975)
data$feature4[data$feature4<lower_bound]<-lower_bound
data$feature4[data$feature4>upper_bound]<-upper_bound
boxplot(data$feature4)
# 2.5
lower_bound<-quantile(data$feature5, 0.025)
upper_bound<-quantile(data$feature5, 0.975)
data$feature5[data$feature5<lower_bound]<-lower_bound
data$feature5[data$feature5>upper_bound]<-upper_bound
boxplot(data$feature5)
# 2.6
lower_bound<-quantile(data$feature6, 0.025)
upper_bound<-quantile(data$feature6, 0.975)
data$feature6[data$feature6<lower_bound]<-lower_bound
data$feature6[data$feature6>upper_bound]<-upper_bound
boxplot(data$feature6)
# 2.7
lower_bound<-quantile(data$feature7, 0.025)
upper_bound<-quantile(data$feature7, 0.975)
data$feature7[data$feature7<lower_bound]<-lower_bound
data$feature7[data$feature7>upper_bound]<-upper_bound
boxplot(data$feature7)
# 2.8
lower_bound<-quantile(data$feature8, 0.025)
upper_bound<-quantile(data$feature8, 0.975)
data$feature8[data$feature8<lower_bound]<-lower_bound
data$feature8[data$feature8>upper_bound]<-upper_bound
boxplot(data$feature8)
# 2.9
lower_bound<-quantile(data$feature9, 0.025)
upper_bound<-quantile(data$feature9, 0.975)
data$feature9[data$feature9<lower_bound]<-lower_bound
data$feature9[data$feature9>upper_bound]<-upper_bound
boxplot(data$feature9)
# 2.10
lower_bound<-quantile(data$feature10, 0.025)
upper_bound<-quantile(data$feature10, 0.975)
data$feature10[data$feature10<lower_bound]<-lower_bound
data$feature10[data$feature10>upper_bound]<-upper_bound
boxplot(data$feature10)
# 2.11
lower_bound<-quantile(data$feature11, 0.025)
upper_bound<-quantile(data$feature11, 0.975)
data$feature11[data$feature11<lower_bound]<-lower_bound
data$feature11[data$feature11>upper_bound]<-upper_bound
boxplot(data$feature11)
# 2.12
lower_bound<-quantile(data$feature12, 0.025)
upper_bound<-quantile(data$feature12, 0.975)
data$feature12[data$feature12<lower_bound]<-lower_bound
data$feature12[data$feature12>upper_bound]<-upper_bound
boxplot(data$feature12)
# 2.13
lower_bound<-quantile(data$feature13, 0.025)
upper_bound<-quantile(data$feature13, 0.975)
data$feature13[data$feature13<lower_bound]<-lower_bound
data$feature13[data$feature13>upper_bound]<-upper_bound
boxplot(data$feature13)
# 2.14
lower_bound<-quantile(data$feature14, 0.025)
upper_bound<-quantile(data$feature14, 0.975)
data$feature14[data$feature14<lower_bound]<-lower_bound
data$feature14[data$feature14>upper_bound]<-upper_bound
boxplot(data$feature14)
# 2.15
lower_bound<-quantile(data$feature15, 0.025)
upper_bound<-quantile(data$feature15, 0.975)
data$feature15[data$feature15<lower_bound]<-lower_bound
data$feature15[data$feature15>upper_bound]<-upper_bound
boxplot(data$feature15)
# 2.16
lower_bound<-quantile(data$feature16, 0.025)
upper_bound<-quantile(data$feature16, 0.975)
data$feature16[data$feature16<lower_bound]<-lower_bound
data$feature16[data$feature16>upper_bound]<-upper_bound
boxplot(data$feature16)
# 2.17
lower_bound<-quantile(data$feature17, 0.025)
upper_bound<-quantile(data$feature17, 0.975)
data$feature17[data$feature17<lower_bound]<-lower_bound
data$feature17[data$feature17>upper_bound]<-upper_bound
boxplot(data$feature17)
# 2.18
lower_bound<-quantile(data$feature18, 0.025)
upper_bound<-quantile(data$feature18, 0.975)
data$feature18[data$feature18<lower_bound]<-lower_bound
data$feature18[data$feature18>upper_bound]<-upper_bound
boxplot(data$feature18)
# 2.19
lower_bound<-quantile(data$feature19, 0.025)
upper_bound<-quantile(data$feature19, 0.975)
data$feature19[data$feature19<lower_bound]<-lower_bound
data$feature19[data$feature19>upper_bound]<-upper_bound
boxplot(data$feature19)
# 2.20
lower_bound<-quantile(data$feature20, 0.025)
upper_bound<-quantile(data$feature20, 0.975)
data$feature20[data$feature20<lower_bound]<-lower_bound
data$feature20[data$feature20>upper_bound]<-upper_bound
...
for(i in ssss){ 
  print(i)
  cM<-table(truth=train1_1_test$label, prediction=result[,2]>i)
  print(cM[1,1]+cM[2,2])
} # threshold=0.47 best / 0.5 / nope .47 is better
...
write.csv(out_pred, file='result_4.csv', row.names = F) # one best or all model?
